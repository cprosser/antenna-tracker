...
if __name__ == "__main__":
    ...
    #dde = DDEClient("Orbitron", "Tracking")
    #dde.advise("TrackingData")    # Last bid quantity
    # sends a sequence of bytes of the form
    # b'TrackingData': b'SNAO-7 AZ54.4 EL0.0 DN100000000 UP100000000'

    dde = DDEClient("NFW32", "NFW_DATA")
    dde.advise("NFW_SERVER")    # Last bid quantity
    # b'NFW_SERVER': b'AO-7 AZ:51.7 EL:+0.0 RR:2.5281700256 AH:N'
